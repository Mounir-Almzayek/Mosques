...
class DesignSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<DesignBloc>(
      ...
      child: const _DesignSectionBody(),
    );
  }
}

class _DesignSectionBody extends StatelessWidget {
  const _DesignSectionBody();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ColorSettingsSection(
                            ...
                            onPrimaryChanged: (val) => bloc
                                .add(DesignColorChanged(DesignColorField.primary, val)),
                            onSecondaryChanged: (val) => bloc
                                .add(DesignColorChanged(DesignColorField.secondary, val)),
                            onActiveCardChanged: (val) => bloc
                                .add(DesignColorChanged(DesignColorField.activeCard, val)),
                            ...
                            onPrayerOverlayChanged: (val) => bloc.add(
                                DesignColorChanged(DesignColorField.prayerOverlay, val)),
                          ),
                          const SizedBox(height: 20),
                          ...
                          FontSizeSettingsSection(
                            ...
                            onClockSizeChanged: (val) => bloc.add(
                                DesignFontSizeChanged(DesignFontSizeField.clock, val)),
                            onMosqueInfoSizeChanged: (val) => bloc.add(
                              DesignFontSizeChanged(DesignFontSizeField.mosqueInfo, val),
                            ),
                            onPrayersSizeChanged: (val) => bloc.add(
                                DesignFontSizeChanged(DesignFontSizeField.prayers, val)),
                            onAnnouncementsSizeChanged: (val) => bloc.add(
                              DesignFontSizeChanged(DesignFontSizeField.announcements, val),
                            ),
                            onReligiousContentSizeChanged: (val) => bloc.add(
                                DesignFontSizeChanged(DesignFontSizeField.religiousContent, val)),
                            onAlertsSizeChanged: (val) => bloc.add(
                                DesignFontSizeChanged(DesignFontSizeField.alerts, val)),
                            onCountdownSizeChanged: (val) => bloc.add(
                                DesignFontSizeChanged(DesignFontSizeField.countdown, val)),
                          ),
                          const SizedBox(height: 20),
                        ...
                        child: Container(
                          ...
                          child: FilledButton.icon(
                            onPressed: state.isSaving
                                ? null
                                : () => bloc.add(const SaveDesignRequested()),
