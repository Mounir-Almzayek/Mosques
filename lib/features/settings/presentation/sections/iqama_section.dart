      ...
      child: ListView(
        ...
        children: [
          ...
          OffsetStepperField(
            ...
            onChanged: (n) => bloc.add(IqamaOffsetChanged(IqamaField.fajr, n)),
          ),
          OffsetStepperField(
            label: s.prayer_dhuhr,
            value: i.dhuhrOffset,
            suffix: s.minutes_short,
            onChanged: (n) => bloc.add(IqamaOffsetChanged(IqamaField.dhuhr, n)),
          ),
          OffsetStepperField(
            label: s.prayer_asr,
            value: i.asrOffset,
            suffix: s.minutes_short,
            onChanged: (n) => bloc.add(IqamaOffsetChanged(IqamaField.asr, n)),
          ),
          OffsetStepperField(
            label: s.prayer_maghrib,
            value: i.maghribOffset,
            suffix: s.minutes_short,
            onChanged: (n) => bloc.add(IqamaOffsetChanged(IqamaField.maghrib, n)),
          ),
          OffsetStepperField(
            label: s.prayer_isha,
            value: i.ishaOffset,
            suffix: s.minutes_short,
            onChanged: (n) => bloc.add(IqamaOffsetChanged(IqamaField.isha, n)),
          ),
          OffsetStepperField(
