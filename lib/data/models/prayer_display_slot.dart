...
/// بطاقات شاشة العرض — يطابق الجزء الأول من [PrayerDisplayPhase.prayerNameKey] (مثل FAJR، FAJR من «FAJR (TOMORROW)»).
enum PrayerDisplaySlot {
  ...
  /// مفتاح المرحلة كما يأتي من [PrayerDisplayPhase] / adhan (FAJR، DHUHR، …).
